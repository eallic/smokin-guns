...
// to float #pragma warning(disable : 4310)		// cast truncates
// constant value #pragma warning(disable:  4505) 	// unreferenced local
...
#define CVAR_TEMP                                                              \
    0x0100 // can be set even when cheats are disabled, but is not archived
#define CVAR_CHEAT 0x0200     // can not be changed if cheats are disabled
#define CVAR_NORESTART 0x0400 // do not clear when a cvar_restart is issued

#define CVAR_SERVER_CREATED                                                    \
    0x0800 // cvar was created by a server the client connected to.
#define CVAR_VM_CREATED                                                        \
    0x1000 // cvar was created exclusively in one of the VMs.
#define CVAR_PROTECTED                                                         \
    0x2000 // prevent modifying this var from VMs or the server
...
#define BUTTON_CHOOSE_MODE                                                     \
    16384 // +button14, to notify the server that the client
