...
void Netchan_TransmitNextFragment(netchan_t *chan) {
    ...
    if (!chan->compat)
#endif
        MSG_WriteLong(&send, NETCHAN_GENCHECKSUM(chan->challenge,
...
qboolean Netchan_Process(netchan_t *chan, msg_t *msg) {
    ...
    if (fragmented) {
        ...
        // we don't reconstruct the fragments. we will wait till this fragment
        // gets to us again (NOTE: we could probably try to rebuild by out of
        // order chunks if needed)
