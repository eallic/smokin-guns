...
#define REFENTITYNUM_BITS                                                      \
    10 // can't be increased without changing drawsurf bit packing
#define REFENTITYNUM_MASK ((1 << REFENTITYNUM_BITS) - 1)
// the last N-bit number (2^REFENTITYNUM_BITS - 1) is reserved for the special
// world refentity,
//  and this is reflected by the value of MAX_REFENTITIES (which therefore is
//  not a power-of-2)
...
#define RF_THIRD_PERSON                                                        \
    0x0002 // don't draw through eyes, only mirrors (player bodies, chat
           // sprites)
#define RF_FIRST_PERSON                                                        \
    0x0004 // only draw through eyes (view weapon, damage blood blob)
#define RF_DEPTHHACK 0x0008 // for view weapon Z crunching

#define RF_CROSSHAIR                                                           \
    0x0010 // This item is a cross hair and will draw over everything similar to
           // DEPTHHACK in stereo rendering mode, with the difference that the
           // projection matrix won't be hacked to reduce the stereo separation
           // as is done for the gun.
