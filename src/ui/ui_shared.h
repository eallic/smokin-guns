...
#define WINDOW_FORECOLORSET                                                    \
    0x00000200 // forecolor was explicitly set ( used to color alpha images or
               // not )
#define WINDOW_HORIZONTAL                                                      \
    0x00000400 // for list boxes and sliders, vertical is default this is set of
               // horizontal
...
typedef struct itemDef_s {
    ...
    int textalignment; // ( optional ) alignment for text within rect based on
                       // text width
    ...
    const char *enableCvar; // enable, disable, show, or hide based on value,
                            // this can contain a list
