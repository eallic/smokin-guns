...
#define ITEM_TEXTSTYLE_OUTLINESHADOWED                                         \
    5                                 // drop shadow ( need a color for this )
#define ITEM_TEXTSTYLE_SHADOWEDMORE 6 // drop shadow ( need a color for this )

#define WINDOW_BORDER_NONE 0 // no border
#define WINDOW_BORDER_FULL                                                     \
    1 // full border based on border color ( single pixel )
...
#define CG_HOLDABLES 103
#define CG_AMMO_WEAPON1 104
#define CG_AMMO_WEAPON2 105
...
#define CG_BUTTON_SHOTGUNS 152
#define CG_BUTTON_MACHINEGUNS 153
#define CG_BUTTON_MISC 154
#define CG_BUTTON_PRIM_AMMO 155
#define CG_BUTTON_SEC_AMMO 156

// buttons in the next menu
#define CG_BUTTON1 157
#define CG_BUTTON2 158
#define CG_BUTTON3 159
#define CG_BUTTON4 160
#define CG_BUTTON5 161
#define CG_BUTTON6 162

// menus
#define CG_ITEMBOX 163
#define CG_BUY_END 164

#define CG_ROUNDTIME 165
...
#define UI_MAPDESC_LINE3 260
#define UI_MAPDESC_LINE4 261
#define UI_MAPDESC_LINE5 262
#define UI_MAPDESC_LINE6 263
#define UI_MAPDESC_LONGNAME 264
...
#define VOICECHAT_CAMP                                                         \
    "camp" // command someone to camp (we don't have sounds for this one)
#define VOICECHAT_FOLLOWME "followme"     // command someone to follow you
#define VOICECHAT_RETURNFLAG "returnflag" // command someone to return our flag
#define VOICECHAT_FOLLOWFLAGCARRIER                                            \
    "followflagcarrier"     // command someone to follow the flag carrier
...
#define VOICECHAT_ONFOLLOWCARRIER                                              \
    "onfollowcarrier"                         // I'm following the flag carrier
...
#define VOICECHAT_KILLGAUNTLET                                                 \
    "kill_gauntlet"               // I just killed you with the gauntlet
