...
static cvarTable_t cvarTable[] = {
    ...
    {&cg_redTeamName, "g_redteam", DEFAULT_REDTEAM_NAME,
     CVAR_ARCHIVE | CVAR_SERVERINFO | CVAR_USERINFO},
    {&cg_blueTeamName, "g_blueteam", DEFAULT_BLUETEAM_NAME,
     CVAR_ARCHIVE | CVAR_SERVERINFO | CVAR_USERINFO},
...
static void CG_RegisterSounds(void) {
    ...
    cgs.media.tracerSound =
        trap_S_RegisterSound("sound/weapons/machinegun/buletby1.wav", qfalse);
    cgs.media.selectSound =
        trap_S_RegisterSound("sound/weapons/change.wav", qfalse);
    cgs.media.snd_pistol_raise =
        trap_S_RegisterSound("sound/weapons/changeto_pistol.wav", qfalse);
    cgs.media.snd_winch66_raise =
        trap_S_RegisterSound("sound/weapons/changeto_winch66.wav", qfalse);
    cgs.media.snd_lightn_raise =
        trap_S_RegisterSound("sound/weapons/changeto_lightning.wav", qfalse);
    cgs.media.snd_sharps_raise =
        trap_S_RegisterSound("sound/weapons/changeto_sharps.wav", qfalse);
    cgs.media.snd_shotgun_raise =
        trap_S_RegisterSound("sound/weapons/changeto_shotgun.wav", qfalse);
    cgs.media.snd_winch97_raise =
        trap_S_RegisterSound("sound/weapons/changeto_winch97.wav", qfalse);
    CG_LoadingStage(1);


    cgs.media.noAmmoSound =
        trap_S_RegisterSound("sound/weapons/noammo.wav", qfalse);

    cgs.media.talkSound = trap_S_RegisterSound("sound/player/talk.wav", qfalse);
    cgs.media.talkSound1 =
        trap_S_RegisterSound("sound/player/talk1.wav", qfalse);
    cgs.media.talkSound2 =
        trap_S_RegisterSound("sound/player/talk2.wav", qfalse);
    cgs.media.talkSound3 =
        trap_S_RegisterSound("sound/player/talk3.wav", qfalse);
    CG_LoadingStage(1);
    cgs.media.landSound =
    ...
    // death sounds
    cgs.media.snd_death[0] =
        trap_S_RegisterSound("sound/player/death_default.wav", qfalse);
    cgs.media.snd_death[1] =
        trap_S_RegisterSound("sound/player/death_head.wav", qfalse);
    cgs.media.snd_death[2] = cgs.media.snd_death[3] =
        trap_S_RegisterSound("sound/player/death_arm.wav", qfalse);
    cgs.media.snd_death[4] =
        trap_S_RegisterSound("sound/player/death_chest.wav", qfalse);
    cgs.media.snd_death[5] =
        trap_S_RegisterSound("sound/player/death_stomach.wav", qfalse);
    ...
    cgs.media.snd_death[10] =
        trap_S_RegisterSound("sound/player/death_land.wav", qfalse);
    ...
    cgs.media.sfx_rockexp =
        trap_S_RegisterSound("sound/weapons/exp_1.wav", qfalse);
    // Spoon Sounds
    // round sounds
    /*cgs.media.roundstart = trap_S_RegisterSound( "sound/music/roundstart.wav",
    qfalse); cgs.media.roundwin = trap_S_RegisterSound(
    "sound/music/roundwin.wav", qfalse ); cgs.media.roundlost =
    trap_S_RegisterSound( "sound/music/roundlost.wav", qfalse );*/

    cgs.media.knifehit =
        trap_S_RegisterSound("sound/weapons/knife_hitflesh.wav", qfalse);
    cgs.media.knifehit2 =
        trap_S_RegisterSound("sound/weapons/knife_hitwall.wav", qfalse);
    cgs.media.dynamiteburn =
        trap_S_RegisterSound("sound/weapons/dyn_burn.wav", qfalse);

    CG_LoadingStage(1);

    cgs.media.du_medal_snd =
        trap_S_RegisterSound("sound/misc/du_medal.wav", qfalse);
    cgs.media.du_won_snd =
        trap_S_RegisterSound("sound/misc/du_won.wav", qfalse);

    cgs.media.boilerhit =
        trap_S_RegisterSound("sound/damage/boiler.wav", qfalse);
    cgs.media.dynamitezundan =
        trap_S_RegisterSound("sound/weapons/dyn_burn2.wav", qfalse);
    cgs.media.sfxglassgib[0] =
        trap_S_RegisterSound("sound/gibs/glass1.wav", qfalse);
    cgs.media.sfxglassgib[1] =
        trap_S_RegisterSound("sound/gibs/glass2.wav", qfalse);
    cgs.media.sfxstonegib =
        trap_S_RegisterSound("sound/gibs/stone1.wav", qfalse);

    cgs.media.underwater =
    ...
    cgs.media.peacem_reload2 =
        trap_S_RegisterSound("sound/weapons/peacem_reload2.wav", qfalse);
    cgs.media.winch97_reload2 =
        trap_S_RegisterSound("sound/weapons/winch97_reload2.wav", qfalse);
    cgs.media.rifle_reload2 =
        trap_S_RegisterSound("sound/weapons/rifle_reload2.wav", qfalse);

    cgs.media.scopePutSound =
        trap_S_RegisterSound("sound/weapons/scope.wav", qfalse);
    cgs.media.gatling_build =
        trap_S_RegisterSound("sound/weapons/gatling_build.wav", qfalse);
    cgs.media.gatling_dism =
        trap_S_RegisterSound("sound/weapons/gatling_dism.wav", qfalse);

    //	cgs.media.buySound = trap_S_RegisterSound("sound/misc/buy_sound.wav",
    //qfalse);

    CG_LoadingStage(1);

    // cgs.media.reloadRifle  =
    // trap_S_RegisterSound("sound/weapons/shotgun/reload.wav", qfalse);
    cgs.media.reloadShotgun =
        trap_S_RegisterSound("sound/weapons/shotgun_reload.wav", qfalse);
    // cgs.media.reloadRifle2 =
    // trap_S_RegisterSound("sound/weapons/shotgun/reload2.wav", qfalse);
    cgs.media.sfx_gatling_loop =
        trap_S_RegisterSound("sound/weapons/gatling_loop.wav", qfalse);
    ...
    for (i = 0; i < 3; i++) {
        ...
        Com_sprintf(name, sizeof(name), "sound/weapons/ric_default%i.wav",
                    i + 1);
        cgs.media.impact[IMPACT_DEFAULT][i] =
            trap_S_RegisterSound(name, qfalse);
...
static void CG_RegisterGraphics(void) {
    ...
    static char *sb_nums[11] = {
        "hud/0", "hud/1", "hud/2", "hud/3", "hud/4",     "hud/5",
        "hud/6", "hud/7", "hud/8", "hud/9", "hud/minus",
    };

    static char *sb_nums_money[11] = {
        "hud/money0", "hud/money1", "hud/money2",     "hud/money3",
        "hud/money4", "hud/money5", "hud/money6",     "hud/money7",
        "hud/money8", "hud/money9", "hud/moneyminus",
    };
    ...
    for (i = 0; i < 11; i++) {
        cgs.media.numbermoneyShaders[i] =
            trap_R_RegisterShader(sb_nums_money[i]);
    }
    ...
    cgs.media.hud_ammo_bullet =
        trap_R_RegisterShaderNoMip("hud/ammo_bullet.tga");
    cgs.media.hud_ammo_sharps =
        trap_R_RegisterShaderNoMip("hud/ammo_sharps.tga");
    ...
    cgs.media.hud_button =
        trap_R_RegisterShaderNoMip("ui/wq3_assets/button.tga");
    cgs.media.hud_button_selected =
        trap_R_RegisterShaderNoMip("ui/wq3_assets/button_selected.tga");
    ...
    cgs.media.menu_arrow =
        trap_R_RegisterShaderNoMip("ui/wq3_assets/menu_arrow");
    ...
    cgs.media.scopecrossShader =
        trap_R_RegisterShaderNoMip("gfx/2d/scopecrosshair");

    CG_LoadingStage(1);

    // Spoon End

    cgs.media.botSkillShaders[0] =
        trap_R_RegisterShaderNoMip("gfx/score/botskill1.tga");
    cgs.media.botSkillShaders[1] =
        trap_R_RegisterShaderNoMip("gfx/score/botskill2.tga");
    cgs.media.botSkillShaders[2] =
        trap_R_RegisterShaderNoMip("gfx/score/botskill3.tga");
    cgs.media.botSkillShaders[3] =
        trap_R_RegisterShaderNoMip("gfx/score/botskill4.tga");
    cgs.media.botSkillShaders[4] =
        trap_R_RegisterShaderNoMip("gfx/score/botskill5.tga");
    ...
    cgs.media.smokePuffRageProShader =
        trap_R_RegisterShader("smokePuffRagePro");
    cgs.media.shotgunSmokePuffShader =
        trap_R_RegisterShader("shotgunSmokePuff");
    CG_LoadingStage(1);
    ...
    for (i = 0; i < NUM_CROSSHAIRS; i++) {
        cgs.media.crosshairShader[i] =
            trap_R_RegisterShader(va("hud/crosshair%c", 'a' + i));
    }
    cgs.media.crosshairFriendShader =
        trap_R_RegisterShader("hud/crosshair_friend");
    ...
    cgs.media.e_knife =
        trap_R_RegisterModel("models/weapons2/knife/e_knife_hold.md3");
    cgs.media.e_dynamite =
        trap_R_RegisterModel("models/weapons2/dyn/e_dynamite_hold.md3");
    cgs.media.e_moneybag = trap_R_RegisterModel("models/items/e_moneybag.md3");

    // scope
    cgs.media.model_scope =
        trap_R_RegisterModel("models/weapons2/scope/scope.md3");

    // smoke effects
    cgs.media.pistol_smoke =
        trap_R_RegisterShaderNoMip("wqfx/pistol_smoke.tga");
    cgs.media.ent_smoke = trap_R_RegisterShaderNoMip("wqfx/smoke.tga");

    // additional weapon icons
    cgs.media.sharps_scope =
        trap_R_RegisterShaderNoMip("hud/weapons/sharps_scope.tga");
    cgs.media.scope_sharps =
        trap_R_RegisterShaderNoMip("hud/weapons/scope_sharps.tga");
    ...
    for (i = 0; i < NUM_GIBS; i++) {
        ...
        if (i < 5) {
            Com_sprintf(name, sizeof(name), "models/gibs/papergib%i.md3",
                        i + 1);
    ...
    // molotov gibs
    cgs.media.molotovgib[0] =
        trap_R_RegisterModel("models/weapons2/molotov/gib1.md3");
    cgs.media.molotovgib[1] =
        trap_R_RegisterModel("models/weapons2/molotov/gib2.md3");
    cgs.media.molotovgib[2] =
        trap_R_RegisterModel("models/weapons2/molotov/gib3.md3");
    cgs.media.molotovgib[3] =
        trap_R_RegisterModel("models/weapons2/molotov/gib4.md3");

    // player model additions
    cgs.media.holster_l =
        trap_R_RegisterModel("models/wq3_players/holster_l.md3");
    cgs.media.holster_r =
        trap_R_RegisterModel("models/wq3_players/holster_r.md3");
    ...
    for (j = 0; j < NUM_PREFIXINFO; j++) {
        for (i = 0; i < 3; i++) {
            ...
            Com_sprintf(name, sizeof(name), "particles/particle_%s_%i",
                        prefixInfo[j].name, i + 1);
    ...
    for (j = 0; j < NUM_PREFIXINFO; j++) {
        ...
        Com_sprintf(name, sizeof(name), "gfx/wq_marks/mark_%s",
                    prefixInfo[j].name);
        cgs.media.breakmarks[j] = trap_R_RegisterShader(name);

        for (i = 0; i < 2; i++) {
            Com_sprintf(name, sizeof(name), "gfx/wq_marks/mark_%s_%i",
                        prefixInfo[j].name, i + 1);
    ...
    // gatling gun models
    cgs.media.g_tripod =
        trap_R_RegisterModel("models/weapons2/gatling/g_tripod.md3");
    cgs.media.g_middle =
        trap_R_RegisterModel("models/weapons2/gatling/g_middle.md3");
    cgs.media.g_gatling =
        trap_R_RegisterModel("models/weapons2/gatling/g_gatling.md3");
    cgs.media.g_barrel =
        trap_R_RegisterModel("models/weapons2/gatling/g_barrel.md3");
    cgs.media.g_crank =
        trap_R_RegisterModel("models/weapons2/gatling/g_crank.md3");
    cgs.media.g_hand =
        trap_R_RegisterModel("models/weapons2/gatling/g_hand.md3");
    cgs.media.g_mag = trap_R_RegisterModel("models/weapons2/gatling/g_mag.md3");
    cgs.media.g_mag_v =
        trap_R_RegisterModel("models/weapons2/gatling/g_mag_v.md3");
...
void CG_BuildSpectatorString(void) {
    ...
    for (i = 0; i < MAX_CLIENTS; i++) {
        ...
        if (cgs.clientinfo[i].infoValid &&
            ...
            (cgs.gametype != GT_DUEL || client == -1 ||
             cg.scores[client].realspec)) {
            // TheDoctor: correctly colored
            if (*cg.spectatorList)
                Q_strcat(cg.spectatorList, sizeof(cg.spectatorList), ",   ");
            Q_strcat(
                cg.spectatorList, sizeof(cg.spectatorList),
                va(S_COLOR_WHITE "%s" S_COLOR_YELLOW, cgs.clientinfo[i].name));
        }
    }
...
void CG_PlayMusic(void) {
    ...
    if (cg.custommusic) { // start custom music
        ...
        if (fadetime < MUSICFADE_TIME && fadetime >= 0 &&
            cg.playmusic_starttime) {
        ...
        cg.playmusic_endtime =
            cg.time + trackInfo[trackNum].replays * trackInfo[trackNum].length;
...
void CG_LoadMenus(const char *menuFile) {
    ...
    if (!f) {
        CG_Error(S_COLOR_RED
                 "menu file not found: ui/hud.txt, unable to continue!");
    }
    ...
    if (feederID == FEEDER_REDTEAM_LIST) {
        for (i = 0; i < cg.numScores; i++) {
            if (cg.scores[i].team == TEAM_RED ||
                cg.scores[i].team == TEAM_RED_SPECTATOR) {
                count++;
            }
        }
        ...
        for (i = 0; i < cg.numScores; i++) {
            if (cg.scores[i].team == TEAM_BLUE ||
                cg.scores[i].team == TEAM_BLUE_SPECTATOR) {
                count++;
            }
        }
...
void CG_SetScoreSelection(void *p) {
    ...
    if (cgs.gametype >= GT_TEAM) {
        ...
        Menu_SetFeederSelection(menu, FEEDER_SCOREBOARD, cg.selectedScore,
                                NULL);
    }
}
    ...
    if (info && info->infoValid) {
        ...
        case 1:
            if (team == -1 && cgs.gametype != GT_DUEL) {
                ...
                if (trueteam == TEAM_RED_SPECTATOR ||
                    trueteam == TEAM_BLUE_SPECTATOR)
                    *handle = cgs.media.dead; // CG_StatusHandle(info->teamTask);
                if (cgs.gametype == GT_DUEL && !sp->realspec &&
                    trueteam >= TEAM_SPECTATOR)
...
void CG_Init(int serverMessageNum, int serverCommandSequence, int clientNum) {
    ...
    cgs.media.charsetProp =
        trap_R_RegisterShaderNoMip("menu/art/font1_prop.tga");
