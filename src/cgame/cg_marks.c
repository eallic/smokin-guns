...
=================
*/
// Tequila: doubled to support more marks if r_marksOnTriangleMeshes is on, see
// README
...
void CG_ImpactMark(qhandle_t markShader, const vec3_t origin, const vec3_t dir,
    ...
    numFragments = trap_CM_MarkFragments(4, (void *)originalPoints, projection,
    ...
    for (i = 0, mf = markFragments; i < numFragments; i++, mf++) {
        ...
        mark = CG_AllocMark();
        mark->duration = (duration == -1 ? MARK_TOTAL_TIME : duration);
        mark->time = cg.time;
