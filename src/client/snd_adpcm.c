...
void S_AdpcmEncode(short indata[], char outdata[], int len,
...
/* static */ void S_AdpcmDecode(const char indata[], short *outdata, int len,
                                struct adpcm_state *state) {
...
Returns the amount of memory (in bytes) needed to store the samples in out
internal adpcm format
====================
*/
int S_AdpcmMemoryNeeded(const wavinfo_t *info) {
    ...
    // determine scale to convert from input sampling rate to desired sampling
    // rate
