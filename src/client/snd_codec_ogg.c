...
const ov_callbacks S_OGG_Callbacks = {
    &S_OGG_Callback_read, &S_OGG_Callback_seek, &S_OGG_Callback_close,
    &S_OGG_Callback_tell};
...
int S_OGG_CodecReadStream(snd_stream_t *stream, int bytes, void *buffer) {
    ...
    while (-1) {
        ...
        c = ov_read((OggVorbis_File *)stream->ptr, bufPtr, bytesLeft,
                    IsBigEndian, OGG_SAMPLEWIDTH, 1, &BS);
