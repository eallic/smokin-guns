...
void S_CodecInit() {
    ...
    // Register wav codec last so that it is always tried first when a file
...
=================
*/
void S_CodecShutdown() { codecs = NULL; }
...
void S_CodecCloseStream(snd_stream_t *stream) { stream->codec->close(stream); }
