...
// returns the appropriate synonym context for the current game type and
// situation
...
void BotVisibleTeamMatesAndEnemies(bot_state_t *bs, int *teammates,
                                   int *enemies, float range);
