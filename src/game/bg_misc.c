...
The suspended flag will allow items to hang in the air, otherwise they are
dropped to the next surface.
...
gitem_t bg_itemlist[] = {
    ...
    {"item_boiler_plate",
     ...
     {"models/powerups/holdable/boiler.md3", NULL, NULL, NULL},
    ...
    {"pickup_money",
     ...
     {"models/items/moneybag.md3", NULL, NULL, NULL},
    ...
    {"item_scope",
     "sound/misc/it_pickup.wav",
     {"models/weapons2/scope/scope.md3", NULL, NULL, NULL},
    ...
    {"item_belt",
     "sound/misc/it_pickup.wav",
     {"models/powerups/holdable/belt.md3", NULL, NULL, NULL},
    ...
    {"weapon_winch66",
     ...
     {"models/weapons2/winch66/e_winchester66.md3", NULL, NULL, NULL},
    ...
    {"weapon_lightning",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/colt_light/e_lightning.md3", NULL, NULL, NULL},
    ...
    {"weapon_sharps",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/sharps/e_sharps.md3", NULL, NULL, NULL},
    ...
    {"weapon_gatling",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/gatling/e_gatling.md3", NULL, NULL, NULL},
    ...
    {"weapon_remington58",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/remington58/e_remington58.md3", NULL, NULL, NULL},
    ...
    {"weapon_schofield",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/schofield/e_schofield.md3", NULL, NULL, NULL},
    ...
    {"weapon_peacemaker",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/peacemaker/e_peacemaker.md3", NULL, NULL, NULL},
     ...
     */
    {
        "weapon_dynamite",
        "sound/misc/w_pickup.wav",
        {"models/weapons2/dyn/e_dynamite.md3", NULL, NULL, NULL},
        ...
        WS_MISC,
        /* precache */ "",
        /* sounds */ "" // sound/weapons/grenade/hgrenb1a.wav
     ...
     */
    {
        "weapon_molotov",
        "sound/misc/w_pickup.wav",
        {"models/weapons2/molotov/e_molotov.md3", NULL, NULL, NULL},
    ...
    {"weapon_knife",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/knife/e_knife.md3", NULL, NULL, NULL},
    ...
    {"weapon_shotgun",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/remgauge/e_remington.md3", NULL, NULL, NULL},
    ...
    {"weapon_sawedoff",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/sawedoff/e_sawedoff.md3", NULL, NULL, NULL},
    ...
    {"weapon_winch97",
     "sound/misc/w_pickup.wav",
     {"models/weapons2/winch97/e_winch97.md3", NULL, NULL, NULL},
    ...
    {"ammo_shells",
     ...
     {"models/powerups/ammo/shotgammo.md3", NULL, NULL, NULL},
     /* icon */ "hud/ammo_shell",
     3.2f,
     /* pickup */ "Shells",
     12,
    ...
    {"ammo_bullets",
     "sound/misc/am_pickup.wav",
     {"models/powerups/ammo/pistolammo.md3", NULL, NULL, NULL},
    ...
    {"ammo_dynamite",
     "sound/misc/am_pickup.wav",
     {"models/powerups/ammo/dynammo.md3", NULL, NULL, NULL},
     /* icon */ "hud/weapons/dynamite",
     3,
     /* pickup */ "Dynamite",
     5,
    ...
    {"ammo_cartridges",
     "sound/misc/am_pickup.wav",
     {"models/powerups/ammo/rifleammo.md3", NULL, NULL, NULL},
     /* icon */ "hud/ammo_cart",
     4.1f,
     /* pickup */ "Cartridges",
     12,
...
gitem_t *BG_FindItemForWeapon(weapon_t weapon) {
    ...
    Com_Printf("Couldn't find item for weapon %i\nPlease report on " PRODUCT_URL
               " forum or http://sourceforge.net/projects/smokinguns\n",
               weapon);
    return NULL;
}
...
qboolean BG_CanItemBeGrabbed(int gametype, const entityState_t *ent,
    ...
    // Molotovs, dynamites and knives are no longer affected by belt double ammo
    // effect. See ./code/g_cmds.c : Cmd_BuyItem_f() and
    ...
    case IT_WEAPON:
        ...
        case WP_DYNAMITE:
        case WP_MOLOTOV:
            // Molotovs, dynamites and knives can no longer be affected by belt
            // double ammo effect.
    ...
    case IT_AMMO:
        ...
        case WP_BULLETS_CLIP:
            if (ps->ammo[item->giTag] >=
                bg_weaponlist[WP_PEACEMAKER].maxAmmo * belt)
                return qfalse;
            break;
        case WP_SHELLS_CLIP:
            if (ps->ammo[item->giTag] >=
        ...
        default:
            if (ps->ammo[item->giTag] >=
                bg_weaponlist[item->giTag].maxAmmo * belt)
                return qfalse;
            break;
        }
        return qtrue;
    ...
    case IT_POWERUP:
        ...
        if (item->giTag == PW_GOLD) {
            ...
            if (gametype == GT_BR) {
                ...
                if (ps->stats[STAT_MONEY] >= BG_MAX_MONEY())
                    return qfalse;
            }
        }
...
void BG_EvaluateTrajectory(const trajectory_t *tr, int atTime, vec3_t result) {
    ...
    case TR_GRAVITY_LOW:
        deltaTime = (atTime - tr->trTime) * 0.001; // milliseconds to seconds
        VectorMA(tr->trBase, deltaTime, tr->trDelta, result);
        result[2] -= 0.3 * DEFAULT_GRAVITY * deltaTime *
                     deltaTime; // FIXME: local gravity...
        break;
    case TR_GRAVITY_LOW2:
        deltaTime = (atTime - tr->trTime) * 0.001; // milliseconds to seconds
        VectorMA(tr->trBase, deltaTime, tr->trDelta, result);
        result[2] -= 0.4 * DEFAULT_GRAVITY * deltaTime *
                     deltaTime; // FIXME: local gravity...
        break;
    default:
...
void BG_EvaluateTrajectoryDelta(const trajectory_t *tr, int atTime,
    ...
    case TR_GRAVITY_LOW2:
        ...
        VectorCopy(tr->trDelta, result);
        result[2] -=
            DEFAULT_GRAVITY / 1.5 * deltaTime; // FIXME: local gravity...
        break;
    default:
...
char *eventnames[] = {
    ...
    "EV_FOOTSTEP", "EV_FOOTSTEP_METAL", "EV_FOOTSPLASH", "EV_FOOTWADE",
    "EV_SWIM",
    ...
    "EV_ITEM_RESPAWN", "EV_ITEM_POP", "EV_PLAYER_TELEPORT_IN",
    ...
    "EV_DEBUG_LINE", "EV_STOPLOOPINGSOUND", "EV_TAUNT", "EV_TAUNT_YES",
    "EV_TAUNT_NO", "EV_TAUNT_FOLLOWME", "EV_TAUNT_GETFLAG",
    "EV_TAUNT_GUARDBASE", "EV_TAUNT_PATROL"
...
qboolean BG_ShootThruWall(float *damage, vec3_t start, vec3_t muzzle,
                          int surfaceFlags, vec3_t end,
...
#define MAX_DISTANCE 300
    for (i = 1; i < 10; i++) {
        ...
        if (!tr.allsolid && !tr.startsolid) {
            ...
            // trace into the direction and look if the level has ended after
            // that wall
            ...
            // if the surface doesn't have a right normal vector don't
            // shoouthru(curves)
...
void BG_SetWhiskeyDrop(trajectory_t *tr, vec3_t org, vec3_t normal,
                       vec3_t dir) {
    vec3_t origin;
...
int BG_MapPrefix(char *map, int gametype) {
    ...
    if (gametype == GT_SINGLE_PLAYER || gametype == GT_DUEL ||
        gametype >= GT_BR)
        return GT_FFA;
