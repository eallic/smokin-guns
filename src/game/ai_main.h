...
#define BFL_ATTACK2 0x0000400
#define BFL_BOUGHT 0x0000800 // already bot something this round?
#define BFL_MONEY 0x0001000  // bot is going for the moneybag
#define BFL_AVOID 0x0002000  // bot is avoiding an explosive
#define BFL_ESCAPE 0x0004000 // bot is goind to the escape point
#define BFL_ACTIVATE                                                           \
    0x0008000 // bot is activating something(eg. a func_breakable)
#define BFL_RETREAT 0x0010000 // bot wants to retreat
...
typedef struct bot_state_s {
    ...
    float enemyposition_time;   // time the position and velocity of the enemy
                              // were stored
    ...
    int predictobstacles_goalareanum; // last goal areanum the bot predicted
                                      // obstacles for
    vec3_t aimtarget;
    ...
    int neutralflagstatus; // 0 = at base, 1 = our team has flag, 2 = enemy team
                           // has flag, 3 = enemy team dropped the flag
    ...
    bot_activategoal_t activategoalheap[MAX_ACTIVATESTACK]; // activate goal
                                                            // heap
