...
void G_WriteClientSessionData(gclient_t *client) {
    ...
    s = va("%i %i %i %i %i %i %i", client->sess.sessionTeam,
           client->sess.spectatorNum, client->sess.spectatorState,
           client->sess.spectatorClient, client->sess.wins, client->sess.losses,
...
void G_ReadSessionData(gclient_t *client) {
    ...
    sscanf(s, "%i %i %i %i %i %i %i", &sessionTeam, &client->sess.spectatorNum,
           &spectatorState, &client->sess.spectatorClient, &client->sess.wins,
