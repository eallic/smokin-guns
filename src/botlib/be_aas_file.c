...
void AAS_SwapAASData(void) {
    ...
    for (i = 0; i < aasworld.numbboxes; i++) {
        aasworld.bboxes[i].presencetype =
            LittleLong(aasworld.bboxes[i].presencetype);
    ...
    for (i = 0; i < aasworld.numplanes; i++) {
        for (j = 0; j < 3; j++)
            aasworld.planes[i].normal[j] =
                LittleFloat(aasworld.planes[i].normal[j]);
    ...
    for (i = 0; i < aasworld.numareas; i++) {
        ...
        for (j = 0; j < 3; j++) {
            ...
            aasworld.areas[i].center[j] =
                LittleFloat(aasworld.areas[i].center[j]);
        } // end for
    } // end for
    // area settings
    for (i = 0; i < aasworld.numareasettings; i++) {
        aasworld.areasettings[i].contents =
            LittleLong(aasworld.areasettings[i].contents);
        aasworld.areasettings[i].areaflags =
            LittleLong(aasworld.areasettings[i].areaflags);
        aasworld.areasettings[i].presencetype =
            LittleLong(aasworld.areasettings[i].presencetype);
        aasworld.areasettings[i].cluster =
            LittleLong(aasworld.areasettings[i].cluster);
        aasworld.areasettings[i].clusterareanum =
            LittleLong(aasworld.areasettings[i].clusterareanum);
        aasworld.areasettings[i].numreachableareas =
            LittleLong(aasworld.areasettings[i].numreachableareas);
        aasworld.areasettings[i].firstreachablearea =
            LittleLong(aasworld.areasettings[i].firstreachablearea);
    } // end for
    // area reachability
    for (i = 0; i < aasworld.reachabilitysize; i++) {
        aasworld.reachability[i].areanum =
            LittleLong(aasworld.reachability[i].areanum);
        aasworld.reachability[i].facenum =
            LittleLong(aasworld.reachability[i].facenum);
        aasworld.reachability[i].edgenum =
            LittleLong(aasworld.reachability[i].edgenum);
        for (j = 0; j < 3; j++) {
            aasworld.reachability[i].start[j] =
                LittleFloat(aasworld.reachability[i].start[j]);
            aasworld.reachability[i].end[j] =
                LittleFloat(aasworld.reachability[i].end[j]);
        } // end for
        aasworld.reachability[i].traveltype =
            LittleLong(aasworld.reachability[i].traveltype);
        aasworld.reachability[i].traveltime =
            LittleShort(aasworld.reachability[i].traveltime);
    } // end for
    // nodes
    for (i = 0; i < aasworld.numnodes; i++) {
        aasworld.nodes[i].planenum = LittleLong(aasworld.nodes[i].planenum);
        aasworld.nodes[i].children[0] =
            LittleLong(aasworld.nodes[i].children[0]);
        aasworld.nodes[i].children[1] =
            LittleLong(aasworld.nodes[i].children[1]);
    } // end for
    // cluster portals
    for (i = 0; i < aasworld.numportals; i++) {
        aasworld.portals[i].areanum = LittleLong(aasworld.portals[i].areanum);
        aasworld.portals[i].frontcluster =
            LittleLong(aasworld.portals[i].frontcluster);
        aasworld.portals[i].backcluster =
            LittleLong(aasworld.portals[i].backcluster);
        aasworld.portals[i].clusterareanum[0] =
            LittleLong(aasworld.portals[i].clusterareanum[0]);
        aasworld.portals[i].clusterareanum[1] =
            LittleLong(aasworld.portals[i].clusterareanum[1]);
    } // end for
    ...
    for (i = 0; i < aasworld.numclusters; i++) {
        aasworld.clusters[i].numareas =
            LittleLong(aasworld.clusters[i].numareas);
        aasworld.clusters[i].numreachabilityareas =
            LittleLong(aasworld.clusters[i].numreachabilityareas);
        aasworld.clusters[i].numportals =
            LittleLong(aasworld.clusters[i].numportals);
        aasworld.clusters[i].firstportal =
            LittleLong(aasworld.clusters[i].firstportal);
    } // end for
...
int AAS_LoadAASFile(char *filename) {
    ...
    aasworld.bboxes = (aas_bbox_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_bbox_t));
    ...
    aasworld.vertexes = (aas_vertex_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_vertex_t));
    ...
    aasworld.planes = (aas_plane_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_plane_t));
    ...
    aasworld.edges = (aas_edge_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_edge_t));
    ...
    aasworld.edgeindex = (aas_edgeindex_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_edgeindex_t));
    ...
    aasworld.faces = (aas_face_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_face_t));
    ...
    aasworld.faceindex = (aas_faceindex_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_faceindex_t));
    ...
    aasworld.areas = (aas_area_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_area_t));
    ...
    aasworld.areasettings = (aas_areasettings_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_areasettings_t));
    ...
    aasworld.reachability = (aas_reachability_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_reachability_t));
    ...
    aasworld.nodes = (aas_node_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_node_t));
    ...
    aasworld.portals = (aas_portal_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_portal_t));
    ...
    aasworld.portalindex = (aas_portalindex_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_portalindex_t));
    ...
    aasworld.clusters = (aas_cluster_t *)AAS_LoadAASLump(
        fp, offset, length, &lastoffset, sizeof(aas_cluster_t));
...
int AAS_WriteAASLump(fileHandle_t fp, aas_header_t *h, int lumpnum, void *data,
                     int length) {
    aas_lump_t *lump;
    ...
    lump->fileofs =
        LittleLong(AAS_WriteAASLump_offset); // LittleLong(ftell(fp));
...
qboolean AAS_WriteAASFile(char *filename) {
    ...
    if (!AAS_WriteAASLump(fp, &header, AASLUMP_AREAS, aasworld.areas,
        ...
        return qfalse;
    if (!AAS_WriteAASLump(
            fp, &header, AASLUMP_AREASETTINGS, aasworld.areasettings,
            aasworld.numareasettings * sizeof(aas_areasettings_t)))
        return qfalse;
    if (!AAS_WriteAASLump(
            fp, &header, AASLUMP_REACHABILITY, aasworld.reachability,
            aasworld.reachabilitysize * sizeof(aas_reachability_t)))
        return qfalse;
    ...
    if (!AAS_WriteAASLump(fp, &header, AASLUMP_PORTALS, aasworld.portals,
                          aasworld.numportals * sizeof(aas_portal_t)))
        return qfalse;
    if (!AAS_WriteAASLump(fp, &header, AASLUMP_PORTALINDEX,
