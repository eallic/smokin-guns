...
cvar_t *
    r_allowSoftwareGL; // Don't abort out if a hardware visual can't be obtained
...
void(APIENTRYP qglRenderbufferStorageMultisampleEXT)(GLenum, GLsizei, GLenum,
                                                     GLsizei, GLsizei);
void(APIENTRYP qglFramebufferRenderbufferEXT)(GLenum, GLenum, GLenum, GLuint);
void(APIENTRYP qglFramebufferTexture2DEXT)(GLenum, GLenum, GLenum, GLuint,
                                           GLint);
...
void(APIENTRYP qglBlitFramebufferEXT)(GLint, GLint, GLint, GLint, GLint, GLint,
                                      GLint, GLint, GLenum, GLbitfield);
...
void(APIENTRYP qglShaderSource)(GLuint, GLsizei, const GLchar **,
                                const GLint *);
...
===============
*/
void GLimp_Minimize(void) { SDL_WM_IconifyWindow(); }
...
static int GLimp_SetMode(int mode, qboolean fullscreen, qboolean noborder) {
    ...
    if (videoInfo == NULL) {
        ...
        if (videoInfo->current_h > 0) {
            ...
            displayAspect =
                (float)videoInfo->current_w / (float)videoInfo->current_h;
      ...
      // If not allowing software GL, demand accelerated
...
#ifdef USE_ICON
        {
            SDL_Surface *icon = SDL_CreateRGBSurfaceFrom(
                (void *)CLIENT_WINDOW_ICON.pixel_data, CLIENT_WINDOW_ICON.width,
        ...
        if (!(vidscreen = SDL_SetVideoMode(
                  glConfig.vidWidth, glConfig.vidHeight, colorbits, flags))) {
        ...
        ri.Printf(PRINT_ALL,
                  ...
                  sdlcolorbits, sdlcolorbits, sdlcolorbits, tdepthbits,
                  tstencilbits);
...
static void GLimp_InitExtensions(void) {
    ...
    if (GLimp_HaveExtension("GL_EXT_compiled_vertex_array")) {
        if (r_ext_compiled_vertex_array->value) {
            ...
            qglLockArraysEXT = (void(APIENTRY *)(
                GLint, GLint))SDL_GL_GetProcAddress("glLockArraysEXT");
            qglUnlockArraysEXT = (void(APIENTRY *)(void))SDL_GL_GetProcAddress(
                "glUnlockArraysEXT");
    ...
    if (GLimp_HaveExtension("GL_EXT_texture_filter_anisotropic")) {
        if (r_ext_texture_filter_anisotropic->integer) {
            qglGetIntegerv(GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT,
                           (GLint *)&maxAnisotropy);
            if (maxAnisotropy <= 0) {
                ri.Printf(PRINT_ALL, "...GL_EXT_texture_filter_anisotropic not "
                                     "properly supported!\n");
                maxAnisotropy = 0;
            } else {
                ri.Printf(
    ...
    if (GLimp_HaveExtension("GL_EXT_framebuffer_object") &&
        ...
        qglGenFramebuffersEXT = (void(APIENTRY *)(
            GLsizei, GLuint *))SDL_GL_GetProcAddress("glGenFramebuffersEXT");
        qglBindFramebufferEXT = (void(APIENTRY *)(
            GLenum, GLuint))SDL_GL_GetProcAddress("glBindFramebufferEXT");
        qglGenRenderbuffersEXT = (void(APIENTRY *)(
            GLsizei, GLuint *))SDL_GL_GetProcAddress("glGenRenderbuffersEXT");
        qglBindRenderbufferEXT = (void(APIENTRY *)(
            GLenum, GLuint))SDL_GL_GetProcAddress("glBindRenderbufferEXT");
        ...
        if (GLimp_HaveExtension("GL_EXT_framebuffer_multisample") &&
            ...
            qglRenderbufferStorageMultisampleEXT = (void(APIENTRY *)(
                GLenum, GLsizei, GLenum, GLsizei, GLsizei))
                SDL_GL_GetProcAddress("glRenderbufferStorageMultisampleEXT");
            qglBlitFramebufferEXT = (void(APIENTRY *)(
                GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLenum,
                GLbitfield))SDL_GL_GetProcAddress("glBlitFramebufferEXT");
        } else {
            if (!strstr(glConfig.extensions_string,
                        "GL_EXT_framebuffer_multisample"))
                ri.Printf(
                    PRINT_WARNING,
                    "WARNING: GL_EXT_framebuffer_multisample is missing\n");
            if (!strstr(glConfig.extensions_string, "GL_EXT_framebuffer_blit"))
                ri.Printf(PRINT_WARNING,
                          "WARNING: GL_EXT_framebuffer_blit is missing\n");
        }
        ...
        qglCheckFramebufferStatusEXT = (GLenum(APIENTRY *)(
            GLenum))SDL_GL_GetProcAddress("glCheckFramebufferStatusEXT");
        qglDeleteFramebuffersEXT =
            (void(APIENTRY *)(GLsizei, const GLuint *))SDL_GL_GetProcAddress(
                "glDeleteFramebuffersEXT");
        qglDeleteRenderbuffersEXT =
            (void(APIENTRY *)(GLsizei, const GLuint *))SDL_GL_GetProcAddress(
                "glDeleteRenderbuffersEXT");

        if (!strstr(glConfig.extensions_string, "GL_ARB_depth_texture")) {
            ri.Printf(PRINT_WARNING,
                      "WARNING: GL_ARB_depth_texture is missing\n");
        }
        if (!strstr(glConfig.extensions_string,
                    "GL_EXT_packed_depth_stencil") ||
            !strstr(glConfig.extensions_string, "GL_NV_packed_depth_stencil")) {
            ri.Printf(PRINT_WARNING,
                      "WARNING: packed_depth_stencil is missing\n");
        }
    }
    // added fragment/vertex program extensions
    if (GLimp_HaveExtension("GL_ARB_fragment_shader") &&
        ...
        glslSupported = qtrue;
        qglAttachShader = (void(APIENTRY *)(
            GLuint, GLuint))SDL_GL_GetProcAddress("glAttachShader");
        qglBindAttribLocation =
            (void(APIENTRY *)(GLuint, GLuint, const GLchar *))
                SDL_GL_GetProcAddress("glBindAttribLocation");
        qglCompileShader =
            (void(APIENTRY *)(GLuint))SDL_GL_GetProcAddress("glCompileShader");
        qglCreateProgram =
            (GLuint(APIENTRY *)(void))SDL_GL_GetProcAddress("glCreateProgram");
        qglCreateShader =
            (GLuint(APIENTRY *)(GLenum))SDL_GL_GetProcAddress("glCreateShader");
        qglDeleteProgram =
            (void(APIENTRY *)(GLuint))SDL_GL_GetProcAddress("glDeleteProgram");
        qglDeleteShader =
            (void(APIENTRY *)(GLuint))SDL_GL_GetProcAddress("glDeleteShader");
        qglShaderSource =
            (void(APIENTRY *)(GLuint, GLsizei, const GLchar **, const GLint *))
                SDL_GL_GetProcAddress("glShaderSource");
        qglLinkProgram =
            (void(APIENTRY *)(GLuint))SDL_GL_GetProcAddress("glLinkProgram");
        qglUseProgram =
            (void(APIENTRY *)(GLuint))SDL_GL_GetProcAddress("glUseProgram");
        qglGetUniformLocation =
            (GLint(APIENTRY *)(GLuint, const GLchar *))SDL_GL_GetProcAddress(
                "glGetUniformLocation");
        qglUniform1f = (void(APIENTRY *)(GLint, GLfloat))SDL_GL_GetProcAddress(
            "glUniform1f");
        qglUniform2f = (void(APIENTRY *)(
            GLint, GLfloat, GLfloat))SDL_GL_GetProcAddress("glUniform2f");
        qglUniform1i = (void(APIENTRY *)(GLint, GLint))SDL_GL_GetProcAddress(
            "glUniform1i");
        qglGetProgramiv = (void(APIENTRY *)(
            GLuint, GLenum, GLint *))SDL_GL_GetProcAddress("glGetProgramiv");
        qglGetProgramInfoLog =
            (void(APIENTRY *)(GLuint, GLsizei, GLsizei *, GLchar *))
                SDL_GL_GetProcAddress("glGetProgramInfoLog");
        qglGetShaderiv = (void(APIENTRY *)(
            GLuint, GLenum, GLint *))SDL_GL_GetProcAddress("glGetShaderiv");
        qglGetShaderInfoLog =
            (void(APIENTRY *)(GLuint, GLsizei, GLsizei *, GLchar *))
...
void GLimp_Init(void) {
    ...
    r_allowResize =
        ri.Cvar_Get("r_allowResize", "0", CVAR_ARCHIVE | CVAR_LATCH);
    r_centerWindow =
        ri.Cvar_Get("r_centerWindow", "0", CVAR_ARCHIVE | CVAR_LATCH);
#ifdef FRAMEBUFFER_AND_GLSL_SUPPORT
    r_ext_framebuffer =
        ri.Cvar_Get("r_ext_framebuffer", "0", CVAR_ARCHIVE | CVAR_LATCH);
#endif
    ...
    if (r_fullscreen->modified) {
        ...
        if (s) {
            ...
            if (r_fullscreen->integer &&
                ri.Cvar_VariableIntegerValue("in_nograb")) {
                ri.Printf(PRINT_ALL,
